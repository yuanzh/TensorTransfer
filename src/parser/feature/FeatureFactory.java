...
public class FeatureFactory implements Serializable {
    ...
    public void addDelexicalCFFeatures(DependencyInstance inst, int h, int m, FeatureVector fv) {
		...
		//int f = ((inst.lang + typo.classNum + 1) << numArcFeatBits) << flagBits;
		int n = inst.length;

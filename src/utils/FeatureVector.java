...
public class FeatureVector {
	...
	public FeatureVector(int _nRows, int _capacity) {
		nRows = _nRows;
	...
	public void addEntries(FeatureVector m, double coeff) {
		...
		Utils.Assert(m != null && m.nRows == nRows);
	...
	private static double[] aggVec;
	public void aggregateUnsafe() {
		if (aggVec == null || aggVec.length < nRows) {
			aggVec = new double[nRows];
        }
